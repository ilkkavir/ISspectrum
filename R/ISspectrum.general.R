...
# a test version with different parameter scaling
ISspectrum.general.test <- function(ele=c(1e11,300,0,0),ion=list(c(30.5,.7e11,300,0,0),c(16,.3e11,300,0,0),c(1,0,300,0,0)),fradar=933e6,scattAngle=180,freq=seq(-1000,1000)*10){
#
# a general incoherent scatter spectrum calculation, with max 7  singly-charged ions.
#
# INPUT:
...
print(  psi <- psi / om0)
 ...
 # the spectrum  (4*pi*r_e**2 = 9.978688e-29 m**2, Vallinkoski 1989)
 s <- specCalc(pldfIntTab,nin0,tit0,mim0,psi,vi,kd2,om) * 9.978688e-29 / om0 * n0
