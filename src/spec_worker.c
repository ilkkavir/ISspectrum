...
void adminvec(int *nom,double *pldfvPr,double *pldfvPi,double *apuprv,double *apupiv,double *omv,double *vi,double *psi,double *gam);
...
void specCalc(double *pldfvPr,double *pldfvPi,double *nin0Pr,double *tit0Pr,int *nion,double *mim0Pr,double *psiPr,double *viPr,double *kd2Pr,double *scr,int *nom,double *omPr,double *resPr,int *ifref)
{
